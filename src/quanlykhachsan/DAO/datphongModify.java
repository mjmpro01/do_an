...
public class datphongModify {
    ...
    public boolean insert(datphongDTO dp) throws SQLException {
        ...
        String[] arr = {dp.getMaphong(), dp.getNgaydat(), dp.getNgaynhan(), dp.getHtkh(), dp.getNgaysinh(), dp.getGioitinh(), dp.getSodt(), dp.getCmnd(), dp.getDiachi(), dp.getLoaikhach(), dp.getManv()};
